        ...
        for (Object node : nodes) {
            if (node instanceof Person) {
                ...
                if (person instanceof Programmer) {
                    ...
                    System.out.println("- Persoana: " + programmer.getName() + " ("
                            + dateFormat.format(programmer.getBirthDate()) + ")");
                    ...
                    System.out.println("- Persoana: " + designer.getName() + " ("
                            + dateFormat.format(designer.getBirthDate()) + ")");
